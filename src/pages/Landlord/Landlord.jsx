    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold dark:text-white">Landlords Management</h1>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold dark:text-white">112</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold dark:text-white">420</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold dark:text-white">KSh 25.4M</p>
              </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {landlords.map((landlord) => (
                  <tr key={landlord.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="font-medium dark:text-white">{landlord.name}</div>
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm dark:text-white">{landlord.email}</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">{landlord.phone}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm dark:text-white">{landlord.propertiesCount} Properties</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">{landlord.unitsCount} Units</div>
                    </td>
                    <td className="px-6 py-4">
