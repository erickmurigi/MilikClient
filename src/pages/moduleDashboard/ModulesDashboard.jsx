...
const ModulesDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Your enterprise is currently using{" "}
                      <span className="font-semibold text-green-600">4 of 6</span> purchased modules
                    </p>
                    <div className="flex items-center space-x-4">
            ...
            {quickStats.map((stat, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-gray-100 text-gray-600">Live</span>
                </div>
                    ...
                    {["all", "active", "locked"].map((filterType) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                          filter === filterType ? "bg-white text-gray-900 shadow" : "text-gray-600 hover:text-gray-900"
                        }`}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {filteredModules.map((module) => (
                    <div
                      ...
                      } ${hoveredModule === module.id ? "transform -translate-y-1" : ""} overflow-hidden group`}
                    >
                      <div className="p-6">
                        {/* Module Header */}
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(module.status)} text-white`}
                            >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                          ...
                          <div className="flex items-center space-x-2">
                            {module.status === "locked" ? (
                              ...
                              <>
                                <span className="text-sm font-semibold text-gray-700">{module.subscription}</span>
                                <div
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <p className="text-gray-600 text-sm">© 2024 Milik Corporation. All rights reserved.</p>
              </div>

              <div className="flex items-center space-x-6">
                <button className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Privacy Policy</button>
                <button className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Terms of Service</button>
                <button className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Support</button>
                <button className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Contact</button>
              </div>
            </div>
          </div>
        </footer>
      ...
      {/* ✅ Windows-11 style Start button + attached Start Menu popup */}
      <StartMenu />
    </div>
  );
};
